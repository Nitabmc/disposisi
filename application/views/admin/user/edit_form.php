        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('admin/user/edit') ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="full_name">FULL NAME <code>*</code></label><input class="form-control" type="text" name="full_name" value="<?= $user->full_name; ?>" placeholder="FULL NAME" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="role" name="role" required>
                            <option></option>
                            <option <?php if ($user->role == "admin") : echo "selected";
                                    endif; ?> value="admin">ADMIN</option>
                            <option <?php if ($user->role == "sekretaris") : echo "selected";
