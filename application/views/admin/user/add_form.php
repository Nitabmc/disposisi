            ...
            <div class="card-body">
                <form action="<?php echo site_url('admin/user/save') ?>" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('username') ? 'is-invalid' : '' ?>" type="text" name="username" placeholder="USERNAME" re quired />
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="role" name="role" req uired>
